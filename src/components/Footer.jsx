      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="mt-4 text-xs text-gray-400">
            © {new Date().getFullYear()} Digital Data Consultancy Ltd
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li>
              <Link to="/company-overview" className="hover:text-white">
                Company Overview
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-gray-300">
            ...
            <a href="tel:+442080902929" className="underline hover:text-white">
              +44 (0) 208 090 2929
            </a>
          </p>
          ...
          <p className="text-gray-300 mt-2">
            <strong>Email:</strong>{' '}
            <a href="mailto:info@digitaldataconsultancy.com" className="underline hover:text-white">
